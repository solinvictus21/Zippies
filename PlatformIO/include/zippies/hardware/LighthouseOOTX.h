...
//x axis, OOTX bit 0
#define SYNC_PULSE_J0_MIN           SYNC_PULSE_MIN
//y axis, OOTX bit 0
...
//several of these values are actually 16-bit floating point numbers, but since our target platform doesn't have
//16-bit floats, we treat them as unsigned 16-bit integers for the purpose of allocating space and will have to
//manually convert them after receiving the end of the info block
#pragma pack(push)
#pragma pack(1)
