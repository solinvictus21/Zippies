...
{
  //formula to calculate turn length from the following useful web site
  ...
  /*
  double centerTurnRadius = linearVelocity / (2.0d * sin(angularVelocity));
  double offsetRadius = centerTurnRadius + wheelRadialOffset;
  double desiredPower = offsetRadius * 2.0d * angularVelocity;
